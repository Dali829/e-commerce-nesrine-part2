...
const CartView = () => {
  const basketEndpoint = 'http://localhost:8800/api/basket';
  const [baskets, setBaskets] = useState([]);
  const fetchBaskets = async () => {
    try {
      const response = await fetch(basketEndpoint);
         ...
         <tr>
           <td>
             <div className="row">
               <div className="col-3 d-none d-md-block">
                 <img
                   src={basket.productSelected.image}
                   width="80"
                   alt="..."
                 />
               </div>
               <div className="col">
                 ...
                 >
                   {basket.productSelected.productName}
                 </Link>
           ...
           <td>
             ...
             <small className="d-block text-muted">
               ${basket.productSelected.price} each
             </small>
           </td>
